...
namespace hsd 
{
    ...
    template <typename T>
    T atomic_exchange(atomic<T>* obj, typename atomic<T>::value_type dest)
    {
    	return obj->exchange(dest);
    }

    template <typename T>
    T atomic_exchange(volatile atomic<T>* obj, typename atomic<T>::value_type dest)
    {
    	return obj->exchange(dest);
    }
    ...
    template <typename T>
    T atomic_fetch_add(volatile atomic<T>* obj, typename atomic<T>::difference_type arg)
    {
    	return obj->fetch_add(arg);
    }
    ...
    template <typename T>
    T atomic_fetch_and(atomic<T>* obj, typename atomic<T>::difference_type arg)
    {
    ...
    void atomic_flag_clear_explicit(atomic_flag* flag, memory_order order)
    {
    	flag->clear(order);
    }
    ...
    bool atomic_flag_test_explicit(atomic_flag* flag, memory_order order)
    {
